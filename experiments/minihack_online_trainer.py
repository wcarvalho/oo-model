...
from experiments import minihack_env_utils
...
def setup_experiment_inputs(
  ...
  def environment_factory(seed: int,
    ...
    del seed
    return minihack_env_utils.make_river_environment(
        path=path,
        debug=debug,
  ...
  if FLAGS.train_single:
    ...
    train_many.run(
      ...
      make_program_command=functools.partial(
        ...
        filename='experiments/minihack_online_trainer.py',
