...
class MuZeroArch(hk.RNNCore):
  ...
  def initial_state(self, batch_size: Optional[int],
                    **unused_kwargs) -> muzero_types.TaskAwareState:
  ...
  def __call__(
      ...
      state: muzero_types.TaskAwareState  # [B, ...]
  ) -> Tuple[muzero_types.RootOutput, muzero_types.TaskAwareState]:
    ...
    Returns:
        Tuple[muzero_types.RootOutput, muzero_types.TaskAwareState]: _description_
    """
    ...
    muzero_state = muzero_types.TaskAwareState(
        state=core_outputs,
  ...
  def unroll(
      ...
      state: muzero_types.TaskAwareState  # [T, ...]
  ) -> Tuple[muzero_types.RootOutput, muzero_types.TaskAwareState]:
    """Apply model
  ...
  def apply_model(
      self,
      state: muzero_types.TaskAwareState,
      action: jnp.ndarray,
  ) -> Tuple[muzero_types.ModelOutput, muzero_types.TaskAwareState]:
    """_summary_

    Args:
        state (muzero_types.TaskAwareState): _description_

    Returns:
        Tuple[muzero_types.ModelOutput, muzero_types.TaskAwareState]: _description_
    """
    ...
    new_state = muzero_types.TaskAwareState(
      state=new_state,
      task=state.task,
    )
